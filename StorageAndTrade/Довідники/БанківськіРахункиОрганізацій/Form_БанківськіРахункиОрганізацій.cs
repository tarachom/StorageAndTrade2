...
namespace StorageAndTrade
{
    public partial class Form_БанківськіРахункиОрганізацій : Form
    {
        ...
        private void Form_БанківськіРахункиОрганізацій_Shown(object sender, EventArgs e)
        {
        ...
        private void dataGridViewRecords_CellClick(object sender, DataGridViewCellEventArgs e)
        {
			if (dataGridViewRecords.SelectedRows.Count > 0)
			{
				...
				SelectPointerItem = new Довідники.БанківськіРахункиОрганізацій_Pointer(new UnigueID(dataGridViewRecords.Rows[RowIndex].Cells["ID"].Value.ToString()));
			}
		}
