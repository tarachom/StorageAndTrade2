...
namespace StorageAndTrade
{
    public partial class Form_ВведенняЗалишківЖурнал : Form
    {
        ...
        private void Form_ВведенняЗалишківЖурнал_Shown(object sender, EventArgs e)
        {
        ...
        private void dataGridViewRecords_CellClick(object sender, DataGridViewCellEventArgs e)
        {
			if (dataGridViewRecords.SelectedRows.Count > 0)
			{
				...
				SelectPointerItem = new Документи.ВведенняЗалишків_Pointer(new UnigueID(dataGridViewRecords.Rows[RowIndex].Cells["ID"].Value.ToString()));
			}
		}
